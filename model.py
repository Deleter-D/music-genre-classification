...
from torch.nn import Module, LayerNorm, Sequential, Linear, GELU, Dropout, Softmax, Identity, ModuleList, Parameter
...
class ViT(Module):
    def __init__(self, *, image_size, patch_size, num_classes, dim, depth, heads, mlp_dim, pool='cls', channels=3,
        ...
        self.cls_token = Parameter(torch.randn(1, 1, dim))  # Parameter()定义可学习参数
